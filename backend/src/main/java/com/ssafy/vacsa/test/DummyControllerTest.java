...
import com.ssafy.vacsa.model.RoleType;
...
public class DummyControllerTest {
    ...
    @PutMapping("/dummy/user/update/{id}")
    ...
    // http://localhost:8080/api/dummy/users
    ...
    // http://localhost:8080/api/dummy/user?page=0 0부터 2건씩
